...
impl InteractionAssets {
    pub const PATH_BUTTON_HOVER: &'static str = "audio/sound_effects/Retro Sounds 1/Audio/pickup1.ogg";
    pub const PATH_BUTTON_PRESS: &'static str = "audio/sound_effects/Retro Sounds 1/Audio/pickup1.ogg";
}
