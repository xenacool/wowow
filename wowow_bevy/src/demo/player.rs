...
impl PlayerAssets {
    pub const PATH_DUCKY: &'static str = "images/Tiny Dungeon/Tiles/tile_0099.png";
    pub const PATH_STEP_1: &'static str = "audio/sound_effects/Retro Sounds 1/Audio/jump1.ogg";
    pub const PATH_STEP_2: &'static str = "audio/sound_effects/Retro Sounds 1/Audio/jump1.ogg";
    pub const PATH_STEP_3: &'static str = "audio/sound_effects/Retro Sounds 1/Audio/jump1.ogg";
    pub const PATH_STEP_4: &'static str = "audio/sound_effects/Retro Sounds 1/Audio/jump1.ogg";
}
