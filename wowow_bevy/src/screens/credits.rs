...
fn spawn_credits_screen(mut commands: Commands) {
    commands
        ...
        .with_children(|children| {
            ...
            children.label("Jessica Collins - Sympathizer");
            children.label("Jasmine Park - Support");
            ...
            children.label("Tiny Dungeon, Tiny Town, Cursor Pixel Pack, UI Pack - Pixel Adventure, UI Pixel Pack, Retro Sounds 1, Retro Sounds 2, and Music Loops by Kenney (www.kenney.nl). CC0");
